...
export function ContentTemplates() {
    ...
    const removeTopic = (index: number) => {
        setTemplate((prev) => ({
            ...prev,
            contentTopics:
                prev.contentTopics?.filter((_, i) => i !== index) || [],
        }));
    };
    ...
    const removeSponsor = (index: number) => {
        setTemplate((prev) => ({
            ...prev,
            sponsorNames:
                prev.sponsorNames?.filter((_, i) => i !== index) || [],
            sponsorMessages:
                prev.sponsorMessages?.filter((_, i) => i !== index) || [],
        }));
    };
