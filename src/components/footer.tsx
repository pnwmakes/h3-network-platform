            ...
            <div className='bg-gradient-to-r from-blue-600 to-green-600 py-12'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
                    <h2 className='text-3xl font-bold mb-4'>
                        SUBSCRIBE TO THE H3 NETWORK TODAY! IT&apos;S FREE...SO WHY NOT?
                    </h2>
                ...
                <div className='grid md:grid-cols-3 gap-8'>
                    ...
                    <div className='md:col-span-1'>
                        ...
                        <p className='text-gray-400 mb-6'>
                            ...
                            Find Hope, Help, and Humor through authentic content and real stories.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className='space-y-2'>
                            ...
                            <li>
                                <Link href='/videos' className='text-gray-400 hover:text-white transition-colors duration-200'>
                                    Videos
                                </Link>
                            </li>
                            <li>
