            ...
            <div className='max-w-4xl mx-auto space-y-6'>
                ...
                <div className='bg-white p-6 rounded-lg shadow'>
                    ...
                    <div className='space-y-2'>
                        ...
                        <div className='mt-4'>
                            <p><strong>NextAuth Cookies:</strong></p>
                            <ul className='list-disc ml-6 mt-2'>
                                {cookies.split(';').filter(c => c.includes('next-auth')).map((cookie, i) => (
                                    <li key={i} className='text-sm font-mono'>{cookie.trim()}</li>
                                ))}
                                {cookies.split(';').filter(c => c.includes('next-auth')).length === 0 && (
                                    <li className='text-red-600'>No NextAuth cookies found!</li>
                                )}
                            </ul>
                        </div>
                    </div>
