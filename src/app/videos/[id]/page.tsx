...
export default async function VideoPage({ params }: VideoPageProps) {
  ...
  const progressPercentage = userProgress && video.duration 
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-4">
                <div>
                  ...
                  {video.show && (
                    <p className="text-sm text-gray-600">{video.show.name}</p>
                  )}
                </div>
              </div>
              ...
              >
                <div className="flex space-x-3">
                  <div className="relative w-40 aspect-video rounded-lg overflow-hidden flex-shrink-0">
                    <Image
                      src={relatedVideo.thumbnailUrl || '/placeholder-video.svg'}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center text-xs text-gray-500 mt-1 space-x-2">
                      <span>{relatedVideo.viewCount} views</span>
                      {relatedVideo.publishedAt && (
                        <span>
                          {formatDistanceToNow(new Date(relatedVideo.publishedAt), { addSuffix: true })}
                        </span>
                      )}
                    </div>
                  </div>
