            ...
            <div className='max-w-2xl mx-auto'>
                ...
                <div className='bg-white rounded-lg shadow-lg p-6'>
                    <p className='text-gray-600 mb-6'>
                        Click the button below to populate the H3 Network
                        database with sample content including Noah, Rita,
                        videos, and shows.
                        <br />
                        <small className='text-gray-500'>
                            Now powered by reliable Neon PostgreSQL hosting.
                        </small>
                    </p>
                            ...
                            {result.created && (
                                <div className='mt-3 text-green-700 text-sm'>
                                    ...
                                    <ul className='list-disc list-inside ml-4'>
                                        ...
                                        <li>
                                            {result.created.creators} creators
                                        </li>
