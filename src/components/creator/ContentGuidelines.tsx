  ...
  const guidelines: GuidelineSection[] = [
    {
      ...
      title: "Hope",
      description: "Content that inspires and uplifts our community with stories of transformation, resilience, and positive possibilities.",
      principles: [
    ...
    },
    {
      ...
      title: "Help",
      description: "Practical, actionable content that provides real assistance to people navigating the criminal justice system, recovery, or reentry.",
      principles: [
    ...
    },
    {
      ...
      title: "Humor",
      description: "Healing humor that builds resilience, creates connection, and provides healthy emotional relief while remaining sensitive to trauma.",
      principles: [
  ...
  const communityStandards = [
    {
      ...
      description: "Treat all community members with respect, regardless of their background or current situation.",
      icon: <Users className="h-5 w-5" />
    },
    {
      title: "Privacy & Safety", 
      description: "Protect personal information and avoid sharing details that could compromise safety.",
      icon: <Shield className="h-5 w-5" />
    },
    {
      title: "Accuracy & Honesty",
      description: "Share truthful information and clearly distinguish between personal experience and professional advice.",
      icon: <Target className="h-5 w-5" />
    },
    {
      title: "Constructive Communication",
      description: "Focus on building up the community rather than tearing down individuals or systems.",
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Creating content that brings Hope, Help, and Humor to our community while maintaining safety, dignity, and impact.
        </p>
      </div>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-lg">Guidelines Progress</h3>
      ...
      <Tabs defaultValue="hope" className="w-full">
        <TabsList className="grid grid-cols-4 w-full mb-8">
          <TabsTrigger value="hope" className="flex items-center gap-2">
        ...
        {guidelines.map((guideline, index) => (
          <TabsContent key={index} value={guideline.title.toLowerCase()}>
            <Card>
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {guideline.examples.avoid.map((example, idx) => (
                        <li key={idx} className="flex items-start gap-2 text-sm">
                ...
                <div className="flex justify-end pt-4">
                  <Button
                    onClick={() => markSectionComplete(guideline.title)}
                    disabled={completedSections.has(guideline.title)}
                  >
                    {completedSections.has(guideline.title) ? (
                      <>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-gray-600 text-lg">
                  Building a safe, supportive community for everyone affected by the criminal justice system.
                </p>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="flex justify-end pt-4">
                  <Button
                    onClick={() => markSectionComplete('community')}
                    disabled={completedSections.has('community')}
                  >
                    {completedSections.has('community') ? (
                      <>
                        <CheckCircle className="mr-2 h-4 w-4" />
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  {contentTypes.map((contentType, idx) => (
                    <div key={idx} className="border border-gray-200 rounded-lg p-4">
                      <h4 className="font-semibold text-lg mb-3">{contentType.type}</h4>
                      <ul className="space-y-2">
                        {contentType.guidelines.map((guideline, gIdx) => (
                ...
                <div className="flex justify-end pt-6">
                  <Button
                    onClick={() => markSectionComplete('content-types')}
                    disabled={completedSections.has('content-types')}
                  >
                    {completedSections.has('content-types') ? (
                      <>
                        <CheckCircle className="mr-2 h-4 w-4" />
        ...
        <Card className="bg-green-50 border-green-200">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-green-700 mb-4">
              You&apos;re ready to start creating meaningful content for the H3 Network community.
            </p>
