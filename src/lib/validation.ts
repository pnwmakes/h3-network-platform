...
export const ValidationSchemas = {
    ...
    user: {
        create: z.object({
            ...
            role: z.enum(['USER', 'CREATOR', 'ADMIN', 'SUPER_ADMIN']).optional().default('USER'),
        }),
    ...
    creator: {
        create: z.object({
            ...
            instagramUrl: z.string()
                .regex(/^https:\/\/(www\.)?instagram\.com\/[a-zA-Z0-9._]{1,30}\/?$/, 'Invalid Instagram URL')
                .optional()
                .or(z.literal('')),
            linkedinUrl: z.string()
                ...
                .or(z.literal('')),
            tiktokUrl: z.string()
                .regex(/^https:\/\/(www\.)?tiktok\.com\/@[a-zA-Z0-9._]{1,24}\/?$/, 'Invalid TikTok URL')
                .optional()
                .or(z.literal('')),
        }),
    ...
    video: {
        create: z.object({
            ...
            tags: z.array(z.string().max(50, 'Tag must not exceed 50 characters'))
                ...
                .default([]),
            topic: z.enum([
                'REENTRY', 'ADDICTION', 'INCARCERATION', 'CRIMINAL_JUSTICE_REFORM',
                'GENERAL', 'CRIMINAL_JUSTICE', 'RECOVERY', 'FAMILY', 'RELATIONSHIPS',
                'LAW', 'GAME', 'REHABILITATION', 'NON_PROFIT', 'READING', 'POLITICS'
            ]).optional(),
            guestName: z.string()
...
export function createValidationMiddleware<T>(
    ...
    return async (data: unknown): Promise<T> => {
        const result = await ValidationHelpers.validateInput(schema, data, context);
