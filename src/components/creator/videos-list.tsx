...
import { EyeIcon, PencilIcon, TrashIcon, CalendarIcon } from '@heroicons/react/24/outline';
                                ...
                                <div className="mt-1 flex items-center space-x-2 text-xs text-gray-500">
                                    ...
                                    {video.status === 'SCHEDULED' && video.scheduledAt ? (
                                        <span className="flex items-center">
                                            ...
                                            Scheduled for {formatDistanceToNow(new Date(video.scheduledAt), { addSuffix: true })}
                                        </span>
                                    ) : (
                                        <span>
                                            {video.publishedAt 
