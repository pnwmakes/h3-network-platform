                ...
                <div className='flex items-center h-20'>
                    ...
                    <div className='flex items-center space-x-3'>
                        ...
                        <button
                            ...
                            className='hidden lg:block p-2 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors duration-200'
                    ...
                    <div className='flex min-h-full items-start justify-center p-4 text-center sm:p-0'>
                        <div className='relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-900 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 mt-20'>
                            ...
                            <div className='text-sm text-gray-500 dark:text-gray-400'>
                                <p>Press <kbd className='px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-xs'>Enter</kbd> to search or <kbd className='px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-xs'>Esc</kbd> to close</p>
                            </div>
                        </div>
                    </div>
                </div>
