        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Label htmlFor="showName">Show/Series Name</Label>
                <Input
                  id="showName"
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('funnyFact', e.target.value)}
            ...
            {!profile.isActive && (
              <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-sm text-yellow-800">
                  Your creator account is inactive. Complete your profile to start creating content.
                </p>
              </div>
            )}
          </CardContent>
