                        ...
                        <div className='lg:hidden border-t border-gray-200 dark:border-gray-800 py-4 transition-colors duration-200'>
                            ...
                            <div className='space-y-2'>
                                ...
                                <button
                                    ...
                                    className='flex items-center space-x-2 w-full px-3 py-2 text-base font-medium text-gray-700 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200'
                                >
                                    <svg
                                        className='w-5 h-5'
                                        fill='none'
